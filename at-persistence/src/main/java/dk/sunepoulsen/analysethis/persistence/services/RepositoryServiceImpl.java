...
public class RepositoryServiceImpl extends AbstractPersistenceService implements RepositoryService {
    @Inject
    public RepositoryServiceImpl( PersistenceConnection persistenceConnection ) {
